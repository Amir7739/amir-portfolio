  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Amir Alam</h1>
          </Link>
        </div>
        <div>
          <ul className="lg:flex items-center hidden">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1_gGUZSjfxJkuaaClcxokOeL413FD1UzW/view?usp=sharing"
              target="blank"
            >
              <PrimaryBtn>
                <span>Resume</span>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2024, Amir Alam. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
