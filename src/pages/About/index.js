        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            ...
            <p className="text-neutral font-medium text-center translate-y-[-100%] sm:translate-y-[-0%] sm:mb-2 md:text-left">
              I am highly motivated to develop unique efficient high quality
              high scalable web applications based on project requirements that
              meet client need, as a MERN Stack Developer with a year of
              experience. I am a full-stack developer, with an inclination
              towards nest. js, Node. js, Express. js, MongoDB, React. js, Next.
              js, Redux & Material-Ui (MUI). I strive to develop applications
              that not only deliver a smooth user experience but also offer a
              powerful and scalable back-end.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Amir Alam
              </h2>
              <h2 className="font-medium">
              ...
              <h2 className="font-medium">
                ...
                mdamira949@gmail.com
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>New Delhi,
                India
              </h2>
              <a
