const Items = [
  {
    id: 1,
    mainImage: "/images/hr-portal.png",
    img: [
      "/images/Dashboard.jpeg",
      "/images/admin-emp-dashboard.jpeg",
      "/images/admin-attendance-dashboard.jpeg",
      "/images/emp-attendance-dashboard.jpeg",
      "/images/punchin-breakseet.jpeg",
      "/images/teams-dashboard.jpeg",
      "/images/query-dashboard.jpeg",
    ],
    features: [
      "Dashboard for admins and employees",
      "JWT authentication with role-based access control",
      "Employee management with add, update, and remove functionality",
      "Attendance tracking, including punch-in and punch-out with break logging",
      "Holiday and leave management",
      "Office assets and inventory management",
      "Teams management with CRUD operations",
      "Break sheet for recording breaks",
    ...
    description:
      "This comprehensive Human Resource Management System (HRMS) streamlines HR operations for organizations by offering powerful CRUD capabilities for managing employees, attendance, holidays, assets, inventory, leaves, teams, and more. The system features secure JWT-based authentication with role-based access control, ensuring that only authorized users can access specific functionalities based on their roles. Built with a scalable backend using Nest.js and MongoDB, and a responsive frontend with Next.js, Material-UI, and Redux, the system provides efficient and secure management of HR tasks and processes.",
    category: "business",
